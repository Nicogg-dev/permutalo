...
export default function BasicInfoOneCopy() {
    ...
    return (
        ...
        <Grid container spacing={2}>
            ...
            {typePerson == "Persona Jurídica" ?
                <> <Grid item xs={12}>
                    <Typography variant="h4" fontWeight={600} mt={3} component="h3" sx={{ color: "#008593" }}>
                        Informacion de Contacto
                    </Typography>
                </Grid>
                    <Grid item xs={12}>
                        <Typography variant="p" fontWeight={600} component="p" sx={{ color: "#008593" }}>
                            Contacto 1
                        </Typography>
                    </Grid>
                    <Grid item xs={6}>
                    ...
                    <Grid item xs={12}>
                        <Typography variant="h5" fontWeight={600} mt={3} component="h3" sx={{ color: "#008593" }}>
                                ...
                                <TableHead>
                                    <TableRow>
                                        <TableCell align='center'>
                                            <Typography variant="subtitle1" fontWeight={600} mt={3} component="p" sx={{ color: "#008593" }}>
            ...
            <Grid item xs={12}>
                <Typography variant="p" fontWeight={600} mt={3} component="h3" sx={{ color: "#008593" }}>
