  ...
  return (
    ...
    >
      <div className="hidden h-full md:h-auto min-[800px]:grid grid-cols-12 items-center py-5 gap-4 px-6">
        ...
        >
          <Image src={benkyLogo} alt="benky logo" width={200} />
        </Link>
        <div className="col-span-12 md:col-span-8 flex justify-center gap-4 items-center text-center h-full md:h-auto">
          ...
          <Link href="/#coverage" className="text-white text-sm">
            Hablemos
          </Link>
        </div>
        <div className="col-span-12 md:col-span-2 flex justify-center">
          <button className="group relative inline-flex h-10 items-center justify-center overflow-hidden rounded-3xl px-10 font-light bg-gradient-to-b from-pink_custom via-lightpink_custom to-yellow_custom text-white text-base">
